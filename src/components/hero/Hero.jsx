...
const Hero = () => {
    return (
        <div className=" w-full text-center sm:text-left sm:py-10 px-2 sm:px-4 lg:px-10 relative ">
            <div className="absolute bg-black/20 sm:bg-inherit h-[80%] max-w-[520px] sm:w-[45%] text-white sm:text-black py-[50%] sm:py-[13%] lg:py-[20%] px-2 lg:px-4">
                ...
                <div className="flex gap-2 sm:gap-4 justify-center sm:justify-start my-2 sm:my-6">
